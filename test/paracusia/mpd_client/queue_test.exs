defmodule Paracusia.MpdClient.QueueTest do
  ...
  test "find should return a list of all matching songs" do
    ...
    assert result == [%{"Album" => "Mutter", "AlbumArtist" => "Rammstein",
                        "AlbumArtistSort" => "Rammstein", "Artist" => "Rammstein",
                        "ArtistSort" => "Rammstein", "Date" => "2001", "Disc" => "1",
                        "Genre" => "Industrial", "Last-Modified" => "2016-10-08T09:52:53Z",
