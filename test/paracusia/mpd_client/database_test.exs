defmodule Paracusia.MpdClient.DatabaseTest do
  ...
  test "count_grouped should return the results grouped by the given parameter" do
    ...
    expected = [
      %{"Album" => "Mutter", "songs" => 11, "playtime" => 3048},
      %{"Album" => "Reise, Reise", "songs" => 14, "playtime" => 3385},
      %{"Album" => "Rosenrot", "songs" => 11, "playtime" => 2886},
      %{"Album" => "Sehnsucht", "songs" => 13, "playtime" => 3138}
    ]
  ...
  test "listall should return the URIs inside the given URI" do
    ...
    expected = [
      {"directory", "flac/rammstein_-_mutter_(2001)"},
      {"file", "flac/rammstein_-_mutter_(2001)/01._rammstein__mein_herz_brennt.flac"},
  ...
  test "read_comments should return a map" do
    ...
    expected = %{
      ...
      "TOTALTRACKS" => "11",
      "MUSICBRAINZ_TRACKID" => "f8030bcd-e6e4-48cb-ba0d-58b3a1132ad4",
      "MUSICBRAINZ_ALBUMARTISTID" => "b2d122f9-eadb-4930-a196-8f221eeb0c66",
      "ALBUMARTISTSORT" => "Rammstein",
      "COMMENT" => "EAC FLAC -8",
      "DATE" => "2001",
      "MUSICBRAINZ_RELEASETRACKID" => "1d8b5e73-dda3-3b3b-a723-0492f30c832b",
      "TITLE" => "Sonne",
      "SCRIPT" => "Latn",
      "ALBUM" => "Mutter",
      "BARCODE" => "731454963923",
      "ARTISTS" => "Rammstein",
      ...
      "RELEASECOUNTRY" => "DE",
      "ARTISTSORT" => "Rammstein",
      "CATALOGNUMBER" => "549639-2",
      "RELEASETYPE" => "album",
      "MEDIA" => "CD",
      "ORIGINALDATE" => "2001-04-02",
      "GENRE" => "Industrial",
      "TOTALDISCS" => "1",
      "DISCTOTAL" => "1"
    }
